...
void KrivayaB(double P1[3], double P2[3], double P3[3], double P4[3], double delta_time)
{
	...
	// НА 40 РАСКОМЕНТЬ ВСЕ СТРОЧКИ НИЖЕ
...
void KrivayaE(double P1[3], double P2[3], double P3[3], double P4[3], double delta_time)
{
	static double t_max = 0;
	static bool flagReverse = false;
	...
	// НА 40 РАСКОМЕНТЬ ВСЕ СТРОЧКИ НИЖЕ
	Vector3 P_old = ermitWithoutDraw(P1, P2, P3, P4, !flagReverse ? t_max - delta_time : t_max + delta_time);
...
{    
	...
	KrivayaB(P0, P1, P2, P3, delta_time);
	KrivayaB(PP0, PP1, PP2, PP3, delta_time);
	KrivayaE(P11, P4, R1, R4, delta_time);
	KrivayaE(P111, P44, R11, R44, delta_time);
}   
